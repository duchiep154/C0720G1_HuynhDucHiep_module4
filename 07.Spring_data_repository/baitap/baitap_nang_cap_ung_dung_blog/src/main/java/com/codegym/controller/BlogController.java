...
public class BlogController {
    ...
    public String home(Model model, RedirectAttributes redirectAttributes,
                       @PageableDefault(size = 4) Pageable pageable, @RequestParam Optional<String> keyword) {
    ...
    @GetMapping("/sort")
    public String sortBlogByDateCreate(Model model ,@PageableDefault(size = 4) Pageable pageable) {
        model.addAttribute("blogList", blogService.findAllBlogAndSort(pageable));
        return "blog/home";
    }
}
